...
\begin{figure}[htbp]                     
  \centering                      
  \includegraphics[width=0.99\linewidth]{software/detect.png}                      
  \caption{骨髓血细胞检测界面}                      
...
\begin{figure}[htbp]                     
  \centering                      
  \includegraphics[width=0.99\linewidth]{software/recognition.png}                      
  \caption{骨髓血细胞识别界面}                      
...
\begin{figure}[htbp]                     
  \centering                      
  \includegraphics[width=0.99\linewidth]{software/result.png}                      
  \caption{医生核查界面}                      
...
\begin{figure}[htbp]                     
  \centering                      
  \includegraphics[width=0.99\linewidth]{software/info.png}                      
  \caption{患者数据分析界面}                      
...
\begin{figure}[htbp]                     
  \centering                      
  \includegraphics[width=0.99\linewidth]{software/patient.png}                      
  \caption{患者信息录入页面}                      
