...
\begin{table}
  ...
  \begin{tabular*}{0.90\hsize}{@{}@{\extracolsep{\fill}}cccccc@{}}
    \toprule[1pt]
    主干网络  & 全局注意力路径聚合模块 & IOU预测模块 &$AP_{50}$ & $AP_{75}$ & $AP_{90}$ \\
    \midrule[1pt] 
    RetinaNet    & × & × & 0.9178 & 0.3234 &  36.04  \\
    RetinaNet    & √ & × & 0.9458 & 0.4965 &  41.17  \\ 
    RetinaNet    & × & √ & 0.9556 & 0.5896 & 69.17     \\ 
    RetinaNet    & √ & √ & 0.9542 & 0.5215 &  36.31  \\ 
    \bottomrule[1pt]      
  \end{tabular*} 
\end{table}
