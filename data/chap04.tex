...
\begin{figure}                  
  \centering                   
	\begin{subfigure}{0.48\linewidth}
		\centering
    \includegraphics[width=0.96\linewidth, height=0.77\linewidth]{det_confusion.png}                   
    \caption{RetinaNet检测识别混淆矩阵}
	\end{subfigure}
	\begin{subfigure}{0.48\linewidth}
		\centering
		\includegraphics[width=0.96\linewidth, height=0.77\linewidth]{det_confusion1.png}
...
\begin{table}   
  \caption{RetinaNet网络在置信度大于0.3，IOU=0.5条件下的准确率与召回率}      
  \centering    
